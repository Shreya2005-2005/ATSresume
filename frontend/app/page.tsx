      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Card>
          ...
          <textarea
            ...
            className="w-full h-64 rounded-lg border border-black/10 dark:border-white/15 bg-transparent p-3 text-sm font-mono resize-none focus:outline-none focus:ring-2 focus:ring-black/20 dark:focus:ring-white/20"
          />
          <div className="flex gap-2 mt-3">
            ...
            <button
              ...
              disabled={running}
              className="ml-auto text-sm px-4 py-1.5 rounded-md bg-black text-white dark:bg-white dark:text-black font-medium hover:opacity-90 disabled:opacity-50"
            >
              {running ? "Running..." : "Run Pipeline →"}
            </button>
          </div>
          {running && runMessage && (
            <p className="mt-2 text-xs text-black/50 dark:text-white/50 animate-pulse">{runMessage}</p>
          )}
        </Card>
